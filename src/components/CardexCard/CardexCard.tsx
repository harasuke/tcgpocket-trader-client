    ...
    >
      ...
      <div
        ...
        style={{
          ...
          ...(active ? { transform: "rotate3d(1,0,0, -180deg)" } : {}),
        }}
      >
        <button
          className="cursor-pointer"
          onClick={() => {
            setCardIntentForLanguage({ intent: "offer", cardId: card.id, language: language });
          }}
        >
        ...
        <button
          className="cursor-pointer"
          onClick={() => {
            setCardIntentForLanguage({ intent: "want", cardId: card.id, language: language });
          }}
        >
